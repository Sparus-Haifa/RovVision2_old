...
tmux send-keys -t syncRec "rsync -avuAXEh --progress --info=progress2 --partial-dir=.rsync-partial --remove-source-files --exclude=".git" --exclude="*.py" --exclude="*.bck" --include="*/" --include="*.pkl" --include="*.bin" $REMOTE_SUB:/home/nanosub/proj/RovVision2/records /home/docker/records" ENTER
